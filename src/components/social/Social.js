...
import {ShareDiscoverWeekly} from "../button/ShareDiscoverWeekly";

export const Social = () => {
    return <div className="flex mb-8">
        <GitHub url={config.github} label="GitHub" small={true} color="text-white dark:text-white"></GitHub>

        <Twitter url="https://twitter.com/daviddalbusco" label={`Twitter @daviddalbusco`} small={true} color="text-white dark:text-white"></Twitter>

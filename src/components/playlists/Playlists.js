...
export const Playlists = ({playlists}) => {
      ...
      {Object.keys(playlists).map((key, i) => (
        <div key={key}>
          {renderPlaylistNumber(i)}
            ...
            <hr className="w-24 pb-4 border-t-2 border-purple-300 m-auto" />
  ...
  function renderPlaylistNumber(i) {
    return (
      <h2 className="flex justify-center items-end px-5 pt-4 text-sm sm:text-lg text-gray-600 dark:text-gray-50 tracking-wide">
